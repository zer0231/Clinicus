...
public class SpecificClinic extends AppCompatActivity {
    ...
    private TextView name, address, phone, sunday, monday, tuesday, wednesday, thursday, friday, saturday, waitTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!pickedTime){
                    Toast.makeText(getApplicationContext(), "Please Pick a Time", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                for(Booking booking: bookings){
                    if(booking.equals(b)){  // bookings are at same time
                        Toast.makeText(getApplicationContext(),"This Appointment Is Not Available. Please Try a Different Date and/or Time.", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                ...
                for(DataBaseService service: services){
                    try {
                        ...
                        Toast.makeText(getApplicationContext(),"Please Pick a Service", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
    ...
    public void openMaps() {
        Uri gmmIntentUri = Uri.parse("http://maps.google.co.in/maps?q="+name.getText());
        ...
        saveDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(validDate){
                    ...
                    Toast.makeText(getApplicationContext(), "Clinic is Closed That Day", Toast.LENGTH_SHORT).show();
                }
            }
        });
        b.show();
        ...
        saveTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (valid) {
                    ...
                    Toast.makeText(getApplicationContext(), "Clinic Is Closed At That Time", Toast.LENGTH_SHORT).show();
                }
            }
        });
